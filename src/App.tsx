    ...
    <div className="App">
      <div className="w-screen h-screen overflow-hidden">
        <div className="backgroundimages">
          <img src="assets\images\bg-header-mobile.png" alt="background" className="w-full md:hidden lg:hidden"/>
          <img src="assets\images\bg-header-desktop.png" alt="background" className=" hidden w-full md:block lg:block"/>
        </div>
