    ...
    <div className="App">
      <div className="w-screen h-screen overflow-hidden">
        <div className="backgroundimages">
          <img src="src\assets\images\bg-header-mobile.png" alt="background" className="w-full md:hidden lg:hidden"/>
          <img src="src\assets\images\bg-header-desktop.png" alt="background" className=" hidden w-full md:block lg:block"/>
        </div>
        <div className=" w-[90%]  absolute top-[15%] left-[5%] lg:absolute lg:top-[20%]">
          ...
          <div className=" absolute top-[105%] w-full overflow-hidden md:absolute md:top-[125%] md:h-[25%] lg:h-[20%] lg:w-[60%] lg:left-[20%]">
